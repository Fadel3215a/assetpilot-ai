...
export function ReviewWorkspace({ assetId }: { assetId: string }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <header>
        <h1 className="display-title">{asset.name}</h1>
      ...
      <div className="hero-preview visual-hover rounded-md border border-border">
        <AssetMediaPreview
          asset={asset}
          className="aspect-video w-full lg:min-h-[28rem]"
          priority
        />
      </div>

      {version.metadata.description && (
        <p className="editorial-lead">{version.metadata.description}</p>
      )}

      <section className="editorial-section">
        <h2 className="section-title">Asset Info</h2>
      ...
      <section className="editorial-section">
        <h2 className="section-title">Metadata Check</h2>
        <div className="mt-4">
      ...
      <section className="editorial-section">
        <h2 className="section-title">Curator Decision</h2>
        ...
        <div className="mt-4 space-y-4">
          ...
          <Button variant="ghost" className="w-full sm:w-auto" onClick={() => router.push("/curation")}>
            Return to Queue
          </Button>
        </div>
      </section>
